...
<form method="POST" class="form-horizontal form-bordered" id="mainform" enctype="multipart/form-data">
			...
			<div class="wrapper bg-silver border-bottom">
				<span class="btn-group m-r-5">
					<div class="input-group date" id="datetimepicker1">
						...
						<input type="text" name="posting_date" class="form-control " placeholder="投稿日時" value="2018/07/10 07:41" />
						<div class="input-group-addon">
	...
	<input type="hidden" name="FLUXDEMOTOKEN" value="f4d2399dd82d3418aba6d2d475e8d5c405a2eba1" />
</form>
